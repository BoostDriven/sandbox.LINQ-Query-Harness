...
namespace SampleSupport
{
    public class SampleHarness : IEnumerable<Sample>
    {
        ...
        public SampleHarness()
        {
            ...
            var methods = from sm in samplesType.GetMethods(BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly | BindingFlags.Static)
            ...
            foreach (var method in methods)
            {
                ...
                foreach (Attribute a in method.GetCustomAttributes(false))
                {
                    ...
                    {
                        MethodInfo linked = samplesType.GetMethod(((LinkedMethodAttribute)a).MethodName, (BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance));
